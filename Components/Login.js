    ...
    fetch('https://accounting.suretostop.com/api/auth/login', {
      ...
      .then(resData => {
        if (resData.accessToken) {
          props.navigation.navigate('Projacct', resData.data.id);
        } else {
        ...
        //     AsyncStorage.setItem('refresh', resData.refresh);
      ...
      <View>
        ...
        <View style={{flex: 1, marginTop: 100}}>
          ...
          <View
            ...
            <TouchableOpacity>
              <View
                style={[styles.socialButtons, {backgroundColor: '#0000ff'}]}>
          ...
          <TouchableOpacity
            onPress={() => props.navigation.navigate('SignUpOption')}>
            <Text
              style={[
                styles.text,
                {
