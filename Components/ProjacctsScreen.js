...
export default function ProjacctsScreen({navigation, route}) {
    ...
    <>
      ...
      <ScrollView>
        <View style={{width: '100%', marginLeft: 20, marginTop: 20}}>
          <Text style={{fontSize: 20, fontWeight: 'bold'}}>Project Status</Text>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('Account', user_id)}
          style={{
            borderBottomRightRadius: 50,
